...
## Quick Access Links
- [MATLAB Cheat Sheet](#matlab-cheat-sheet)
  - [Quick Access Links](#quick-access-links)
  - [1. Basics](#1-basics)
    - [i. Comments and Code Sections](#i-comments-and-code-sections)
    - [ii. Helper Commands](#ii-helper-commands)
    - [iii. Variables and Expressions](#iii-variables-and-expressions)
  - [2. Matrices and Vectors](#2-matrices-and-vectors)
    - [i. Declarations](#i-declarations)
    - [ii. Splicing and Dicing](#ii-splicing-and-dicing)
    - [iii. Arithmetic and Operations](#iii-arithmetic-and-operations)
  - [3. Plots](#3-plots)
  - [4. Functions and Scripts](#4-functions-and-scripts)
  - [5. Programming Logic](#5-programming-logic)
  - [6. Math/Engineering](#6-mathengineering)
    - [i. Common Math Functions](#i-common-math-functions)
    - [ii. Transfer Functions](#ii-transfer-functions)
  - [7. Vectorization](#7-vectorization)
  - [8. Optimization](#8-optimization)
  - [9. Machine Learning](#9-machine-learning)
  - [10. Simulink](#10-simulink)
